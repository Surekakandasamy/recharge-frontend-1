  ...
  useEffect(() => {
    const loadTransactions = async () => {
      ...
      try {
        ...
        const response = await fetch(`https://recharge-backend-2daw.onrender.com/api/transactions?userId=${currentUserId}`);
    ...
    loadTransactions();
  }, [state.user, state.wallet, state.lastTransaction, setState]); // Re-fetch when user, wallet, or transactions change
